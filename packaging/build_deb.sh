...
# dependency .debs from /prebuilt, then builds pairs_uav_trackers and copies the .deb to /output.
#   PAIRS deps (build order, supplied from /prebuilt): pairs_msgs pairs_lib pairs_uav_hw_api pairs_uav_managers
set -eo pipefail
ROS_DISTRO_NAME="jazzy"; OS_NAME="ubuntu"; OS_VERSION="noble"
source "/opt/ros/${ROS_DISTRO_NAME}/setup.bash"
set -u

LOCAL_RULES="/src/pairs_uav_trackers/packaging/rosdep/pairs.yaml"
...
build_one /src/pairs_uav_trackers
