...
bool MidairActivationTracker::initialize(const rclcpp::Node::SharedPtr                                        &node,
  ...
  pairs_lib::ParamLoader param_loader_parent(common_handlers->parent_node, "ControlManager");
  ...
  private_handlers->param_loader->addYamlFile(ament_index_cpp::get_package_share_directory("pairs_uav_trackers") +
  ...
  profiler_ = pairs_lib::Profiler(common_handlers->parent_node, "MidairActivationTracker", _profiler_enabled_);
...
std::tuple<bool, std::string> MidairActivationTracker::activate([[maybe_unused]] const std::optional<pairs_msgs::msg::TrackerCommand> &last_tracker_cmd) {
...
std::optional<pairs_msgs::msg::TrackerCommand>
MidairActivationTracker::update(const pairs_msgs::msg::UavState                                      &uav_state,
  ...
  pairs_lib::ScopeTimer timer =
      pairs_lib::ScopeTimer(node_, "MidairActivationTracker::update", common_handlers_->scope_timer.logger, common_handlers_->scope_timer.enabled);
...
const pairs_msgs::msg::TrackerStatus MidairActivationTracker::getStatus() {
...
MidairActivationTracker::switchOdometrySource([[maybe_unused]] const pairs_msgs::msg::UavState &new_uav_state) {
...
const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Response>
MidairActivationTracker::setConstraints([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::DynamicsConstraintsSrv::Request> &request) {
...
MidairActivationTracker::setReference([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::ReferenceSrv::Request> &request) {
...
const std::shared_ptr<pairs_msgs::srv::VelocityReferenceSrv::Response>
MidairActivationTracker::setVelocityReference([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::VelocityReferenceSrv::Request> &request) {
...
const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Response>
MidairActivationTracker::setTrajectoryReference([[maybe_unused]] const std::shared_ptr<pairs_msgs::srv::TrajectoryReferenceSrv::Request> &request) {
